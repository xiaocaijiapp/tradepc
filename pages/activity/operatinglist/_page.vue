  ...
  <div class="activity-list">
    <div class="bread">
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem>运营攻略</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="list">
      <div class="title">
      ...
      <div class="list-box">
        <div v-for="item in list" :key="item.id" class="item"  @click="$router.push('/activity/operating/' + item.id)">
...
export default {
  ...
  methods: {
    changePage (e) {
      this.$router.push('/activity/operatinglist/' + e)
    }
  }
}
</script>
